...
public class ScrouchGameLogicApp implements ScrouchLogicServiceAPI{
	
	final static Logger logger = Logger.getLogger(ScrouchGameLogicApp.class);
	
	private GamesRepositoryManager gamesRepository;
	private PlayersRepository playersRepository;
	
	public ScrouchGameLogicApp() throws IOException {
		super();
		Config.initConfig();
